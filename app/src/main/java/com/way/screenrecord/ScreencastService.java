...
public class ScreencastService extends Service {
    ...
    public static final String ACTION_START_SCREENCAST = "com.way.ACTION_START_SCREENCAST";
    public static final String ACTION_STOP_SCREENCAST = "com.way.ACTION_STOP_SCREENCAST";
    public static final String ACTION_SHOW_TOUCHES = "com.way.ACTION_SHOW_TOUCHES";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("broncho", "onStartCommand action = " + intent.getAction());
        if (TextUtils.equals(intent.getAction(), ACTION_START_SCREENCAST)) {
            try {
                if (!hasAvailableSpace()) {
                ...
                Log.e("broncho", "error", e);
            }
        } else if (TextUtils.equals(intent.getAction(), ACTION_STOP_SCREENCAST)) {
            stopCasting();
        } else if (intent.getAction().equals(ACTION_SHOW_TOUCHES)) {
    ...
    private void addNotificationTouchButton(boolean showingTouches) {
        Intent showTouchesIntent = new Intent(ACTION_SHOW_TOUCHES);
